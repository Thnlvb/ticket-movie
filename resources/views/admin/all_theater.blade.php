     ...
     <div class="row w3-res-tb">
      ...
      <div class="col-sm-3">
        <div class="input-group">
          Tìm kiếm
          <form action="{{URL::to('/search-theater')}}" method="post">
              {{csrf_field()}}
          <input type="text" class="input-sm form-control" name="key_theater" placeholder="Tìm kiếm">
<!--             <button class="btn btn-sm btn-default" type="button">Go!</button> -->
    ...
    <div class="table-responsive">
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
           @foreach($all_movie_theater as $key => $theater)
          <tr>
       ...
       <span>{!!$all_movie_theater->render()!!}</span>
    </div>
  </div>
</div>
@endsection