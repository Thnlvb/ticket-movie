      ...
      <div class="col-sm-2">
        <div class="input-group">
          ...
          <form action="{{URL::to('/search-format')}}" method="post">
              {{csrf_field()}}
          <input type="text" class="input-sm form-control" name="key_format" placeholder="Tìm kiếm">
<!--             <button class="btn btn-sm btn-default" type="button">Go!</button> -->
    ...
    <div class="table-responsive">
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
           @foreach($all_movie_format as $key => $format_pro)
          <tr>
       ...
       <span>{!!$all_movie_format->render()!!}</span>
    </div>
  </div>
</div>
@endsection