                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('/save-showtimes')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="showtimes_status" class="form-control input-sm m-bot15">
                                        <option value="0">Ẩn</option>
                                        <option value="1">Hiển Thị</option>
                                    </select>
                                </div>                                
                                <button type="submit" name="add_showtimes" class="btn btn-info">Thêm Lịch Chiếu Phim</button>
                            </form>
                            </div>
                        </div>
                    </section>
